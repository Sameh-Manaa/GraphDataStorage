...
bool AdjacencyMatrixUniversalTableManager::loadVertices(std::string verticesDirectory, uint8_t filesToLoad) {
...
bool AdjacencyMatrixUniversalTableManager::loadEdges(std::string edgesDirectory, uint8_t filesToLoad) {
...
void AdjacencyMatrixUniversalTableManager::executeQueryBI18(tm messageCreationDate, uint16_t messageLength, std::vector<std::string> messageLanguages, std::vector<std::pair<std::vector<std::string>, std::vector<double> > >& resultSet) {
