...
std::map<int, std::string> CSRSchemaHashedTableManager::getVertexProperties(std::string vertexHeaderLine) {
...
std::map<int, std::string> CSRSchemaHashedTableManager::getEdgeProperties(std::string edgeHeaderLine) {
    std::map<int, std::string> propertiesPositions;
...
void CSRSchemaHashedTableManager::executeQueryBI18(tm messageCreationDate, uint16_t messageLength, std::vector<std::string> messageLanguages, std::vector<std::pair<std::vector<std::string>, std::vector<double> > >& resultSet) {
