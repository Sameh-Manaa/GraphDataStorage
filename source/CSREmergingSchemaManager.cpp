...
bool CSREmergingSchemaManager::loadGraph(std::string verticesDirectory, std::string edgesDirectory, uint8_t filesToLoad) {
...
bool CSREmergingSchemaManager::loadVertices(std::string verticesDirectory, uint8_t filesToLoad) {
...
bool CSREmergingSchemaManager::loadEdges(std::string edgesDirectory, uint8_t filesToLoad) {
...
std::vector<int16_t> CSREmergingSchemaManager::addVertexProperties(std::string vertexHeaderLine) {
...
std::vector<int16_t> CSREmergingSchemaManager::addEdgeProperties(std::string edgeHeaderLine) {
    std::vector<int16_t> propertiesPositions(0);
