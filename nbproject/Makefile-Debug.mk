...
${OBJECTDIR}/source/AdjacencyListUniversalTableManager.o: source/AdjacencyListUniversalTableManager.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iheader -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/AdjacencyListUniversalTableManager.o source/AdjacencyListUniversalTableManager.cpp
...
${OBJECTDIR}/source/ParallelAdjacencyList.o: source/ParallelAdjacencyList.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iheader -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/ParallelAdjacencyList.o source/ParallelAdjacencyList.cpp
...
${OBJECTDIR}/source/ParallelAdjacencyListSchemaHashedTableManager.o: source/ParallelAdjacencyListSchemaHashedTableManager.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iheader -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/ParallelAdjacencyListSchemaHashedTableManager.o source/ParallelAdjacencyListSchemaHashedTableManager.cpp

${OBJECTDIR}/source/ParallelSchemaHashedTable.o: source/ParallelSchemaHashedTable.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iheader -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/ParallelSchemaHashedTable.o source/ParallelSchemaHashedTable.cpp
